...
public class Yogurt extends JFrame implements ActionListener {
	...
	public Yogurt() {
		...
		cboMarca.setModel(new DefaultComboBoxModel<String>(new String[] { "Laive", "Gloria", "Pura Vida", "Milkito" }));
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		else if(marca == "PuraVida"){pre=4.8;}
		else{pre=5.3;}
